...
export default function Hero({ onStartProjectClick, onSeeWorkClick }) {
  return (
    <section id="top" data-section="hero" data-scene="globe" className="relative min-h-[100svh] overflow-hidden flex flex-col">
      ...
      <div className="relative w-full px-6 sm:px-10 lg:px-16 pt-24 lg:pt-28 pb-12 sm:pb-16 drift-up flex flex-col min-h-[100svh] justify-between z-10 flex-1">
        ...
        <div className="max-w-3xl relative z-10 my-auto py-6 sm:py-10">
          <h1
            className="font-display text-[40px] sm:text-[62px] lg:text-[80px] leading-[1.05] tracking-tight font-extrabold text-[var(--ink)] mb-6 sm:mb-8"
            data-split=""
            data-parallax="-0.08"
          >
            Crafting <br />
          ...
          <p 
            className="max-w-xl text-ink/80 text-base sm:text-lg font-normal leading-relaxed"
            data-anim="fade-up"
            data-parallax="-0.04"
          >
        ...
        <div className="mt-auto pt-6" data-anim="fade-up">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-start gap-4 max-w-sm sm:max-w-none">
            ...
            <button
              ...
              data-cursor="link"
              className="btn-ghost px-8 py-4 rounded-full text-sm sm:text-base font-medium inline-flex items-center justify-center gap-2 cursor-pointer"
            >
              See our work
            </button>
          </div>
